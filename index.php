...
?>
  ...
  <ul class="pagination justify-content-center">
    <?php
$total_pages = ceil(getTotalPages() / $limit);
if ($page > 1) {
    echo '<li class="page-item"><a class="page-link" href="?page=' . ($page - 1) . '">Попередня</a></li>';
}
...
if ($page < $total_pages) {
    echo '<li class="page-item"><a class="page-link" href="?page=' . ($page + 1) . '">Наступна</a></li>';
}
?>
  </ul>
</nav>
